...
class DefaultHeaderDropdown extends Component {
  ...
  onLogout() {
    ...
    broker.logout();
    //this.props.onLogout();
    window.location.href = config.base_routing;
  }
  ...
  dropAccnt() {
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <img src={'assets/img/avatars/admin-logo.png'} className="img-avatar" alt="admin@bootstrapmaster.com" />
        </DropdownToggle>
        <DropdownMenu right>
          ...
          <DropdownItem onClick={this.onLogout}><i className="fa fa-lock"></i> <a role="button">Logout</a></DropdownItem>
        </DropdownMenu>
      </Dropdown>
    );
  }
